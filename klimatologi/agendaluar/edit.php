...
<div class="box">
	...
	<h4><small>Edit Data Agenda Luar</small>
	...
	<div class="row">
		<div class="col-lg-6 col-lg-offset-3">
			<?php 
			$id = @$_GET['id'];
			$sql_agendaluar = mysqli_query($con, "SELECT * FROM agenda_keluar WHERE id_agendakel = '$id'");
			$data = mysqli_fetch_array($sql_agendaluar);
			?>
			<form action="proses.php" method="post">
				...
				<div class="form-group">
					...
					<input type="hidden" name="id" value="<?=$data['id_agendakel']?>">
