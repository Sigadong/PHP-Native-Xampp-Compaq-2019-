...
?>
		...
		?>
		<form action="proses_tmbh.php" method="post" id="form_mahasiswa">
			<fieldset>
				<legend>Mahasiswa Baru</legend>
				<p>
					<label for="npm">NPM</label>
					<input type="text" name="npm" id="npm" value="<?php echo $npm ?>" placeholder="contoh 16110234">(8 digit angka)
				</p>
				<p>
